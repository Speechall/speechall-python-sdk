...
class OpenAICreateTranslationResponseJson(BaseModel):
    """
    Standard JSON response for OpenAI-compatible translation requests when `response_format` is `json`. Contains the translated English text.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpenAICreateTranslationResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpenAICreateTranslationResponseJson:
        """Create an instance of OpenAICreateTranslationResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpenAICreateTranslationResponseJson.parse_obj(obj)

        _obj = OpenAICreateTranslationResponseJson.parse_obj({
            "text": obj.get("text")
        })
        return _obj
