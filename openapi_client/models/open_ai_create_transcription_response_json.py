...
class OpenAICreateTranscriptionResponseJson(BaseModel):
    """
    Represents a transcription response returned by model, based on the provided input.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpenAICreateTranscriptionResponseJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpenAICreateTranscriptionResponseJson:
        """Create an instance of OpenAICreateTranscriptionResponseJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpenAICreateTranscriptionResponseJson.parse_obj(obj)

        _obj = OpenAICreateTranscriptionResponseJson.parse_obj({
            "text": obj.get("text")
        })
        return _obj
